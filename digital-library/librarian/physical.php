          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <form action="../backend/add_resource.php" method="post">
                  ...
                  <a href="edit_resource.php?id=<?= $data['id'] ?>" class="btn btn-warning btn-sm">Edit <i class="bx bx-edit"></i></a>
                  <button class="btn btn-danger btn-sm" type="submit" name="delete_resource">Delete <i class="bx bx-trash"></i></button>
              </form>
            </div>
          </div>
        <?php } ?>
