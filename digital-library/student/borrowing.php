...
$records = mysqli_query($con,"select b.*, bb.borrow_date, bb.return_date from books b, borrow bb where bb.status=1 and b.id=bb.book_id and bb.user_id='$user_id'");
    ...
    <div class='main-table-containter'>
        ...
        <div>
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td><div><a href="../books_file/<?= $data['id'] ?>/<?= $data['file'] ?>" target="_blank"><i class="bx bx-download"></i> <?= $data['name'] ?></a></div></td>
