...
<section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Book Resource Form</h2>
        </div>

        <div class="row">

          <div class="col-lg-12 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="../backend/book_resource.php" method="post" enctype="multipart/form-data" role="form" class="php-email-form">
              <div class="row">
              ...
              <div class="text-center"><button type="submit" name="book_resource"><i class="bx bx-book"></i> Book Resource</button></div>
            </form>
          </div>
